...
class contractmandateVO{
    ...
    public function getId_prop_cm(){
        return $this->id_prop;
    }

    public function getId_tip_prop_cm(){
        return $this->id_tip_prop;
    }

    public function getNom_tip_prop_cm(){
        return $this->nom_tip_prop;
    }

    public function getDir_prop_cm(){
        return $this->dir_prop;
    }

    public function getUbi_prop_cm(){
        return $this->ubi_prop;
    }

    public function getDesc_prop_cm(){
        return $this->desc_prop;
    }

    public function getCod_reg_oper_cm(){
        return $this->cod_reg_oper;
    }

    public function getEstado_oper_cm(){
        return $this->estado_oper;
    }

    public function getCed_pers_cm(){
        return $this->ced_pers;
    }

    public function getNom_pers_cm(){
        return $this->nom_pers;
    }

    public function getApe_pers_cm(){
        return $this->ape_pers;
    }

    public function getFec_exp_ced_pers_cm(){
        return $this->fec_exp_ced_pers;
    }

    public function getCel_pers_cm(){
        return $this->cel_pers;
    }

    public function getTel_pers_cm(){
        return $this->tel_pers;
    }

    public function getEmail_pers_cm(){
        return $this->email_pers;
    }

    public function getSex_pers_cm(){
        return $this->sex_pers;
    }

    public function getDir_pers_cm(){
        return $this->dir_pers;
    }

    public function getCiud_pers_cm(){
        return $this->ciud_pers;
    }

    public function getId_tip_oper_cm(){
        return $this->id_tip_oper;
    }

    public function getNom_tip_oper_cm(){
        return $this->nom_tip_oper;
    }

    public function getId_tip_pers_cm(){
        return $this->id_tip_pers;
    }

    public function getNom_tip_pers_cm(){
        return $this->nom_tip_pers;
    }

    public function getCod_arch_cm(){
        return $this->cod_arch;
    }

    public function getNom_arch_cm(){
        return $this->nom_arch;
    }

    public function getNum_arch_cm(){
    ...
    public function setId_prop_cm($id_prop){
        $this->id_prop = $id_prop;
    }

    public function setId_tip_prop_cm($id_tip_prop){
        $this->id_tip_prop = $id_tip_prop;
    }

    public function setNom_tip_prop_cm($nom_tip_prop){
        $this->nom_tip_prop = $nom_tip_prop;
    }

    public function setDir_prop_cm($dir_prop){
        $this->dir_prop = $dir_prop;
    }

    public function setUbi_prop_cm($ubi_prop){
        $this->ubi_prop = $ubi_prop;
    }

    public function setDesc_prop_cm($desc_prop){
        $this->desc_prop = $desc_prop;
    }

    public function setCod_reg_oper_cm($cod_reg_oper){
        $this->cod_reg_oper = $cod_reg_oper;
    }

    public function setEstado_oper_cm($estado_oper){
        $this->estado_oper = $estado_oper;
    }

    public function setCed_pers_cm($ced_pers){
        $this->ced_pers = $ced_pers;
    }

    public function setNom_pers_cm($nom_pers){
        $this->nom_pers = $nom_pers;
    }

    public function setApe_pers_cm($ape_pers){
        $this->ape_pers = $ape_pers;
    }

    public function setFec_exp_ced_pers_cm($fec_exp_ced_pers){
        $this->fec_exp_ced_pers = $fec_exp_ced_pers;
    }

    public function setCel_pers_cm($cel_pers){
        $this->cel_pers = $cel_pers;
    }

    public function setTel_pers_cm($tel_pers){
        $this->tel_pers = $tel_pers;
    }

    public function setEmail_pers_cm($email_pers){
        $this->email_pers = $email_pers;
    }

    public function setSex_pers_cm($sex_pers){
        $this->sex_pers = $sex_pers;
    }
    
    public function setDir_pers_cm($dir_pers){
        $this->dir_pers = $dir_pers;
    }
    
    public function setCiud_pers_cm($ciud_pers){
        $this->ciud_pers = $ciud_pers;
    } 

    public function setId_tip_oper_cm($id_tip_oper){
        $this->id_tip_oper = $id_tip_oper;
    }

    public function setNom_tip_oper_cm($nom_tip_oper){
        $this->nom_tip_oper = $nom_tip_oper;
    }

    public function setId_tip_pers_cm($id_tip_pers){
        $this->id_tip_pers = $id_tip_pers;
    }

    public function setNom_tip_pers_cm($nom_tip_pers){
        $this->nom_tip_pers = $nom_tip_pers;
    }

    public function setCod_arch_cm($cod_arch){
        $this->cod_arch = $cod_arch;
    }

    public function setNom_arch_cm($nom_arch){
        $this->nom_arch = $nom_arch;
    }

    public function setNum_arch_cm($num_arch){
