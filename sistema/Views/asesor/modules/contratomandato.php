        ...
        <form class="form_module" id="form_module" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="body_form">
                ...
                <div class="title_form_dos">
                    ...
                    <div class="body_container_nivelcuatro">
                        <div class="body_label">
                            <label>Contrato de Mandato</label>
                        </div>
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="cdm" id="cdm" accept=".doc, .docx, .pdf">
                        </div>
                    </div>

                    <div class="body_container_nivelcuatro">
                        <div class="body_label">
                            <label>Fotocopia Cédula de Ciudadania</label>
                        </div>
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="fcc" id="fcc" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="cdr" id="cdr" accept=".doc, .docx, .pdf">
                        </div>
                    </div>

                    <div class="body_container_nivelcuatro">
                        <div class="body_label">
                            <label>Certificación Bancaria Propietario</label>
                        </div>
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="cbp" id="cbp" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                ...
                <div class="title_form_dos">
                    ...
                    <div class="body_container_nivelcuatro">
                        <div class="body_label">
                            <label>Escrituras del Inmueble</label>
                        </div>
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="esci" id="esci" accept=".doc, .docx, .pdf">
                        </div>
                    </div>

                    <div class="body_container_nivelcuatro">
                        <div class="body_label">
                            <label>Certificado de Libertad y Extradición del Inmueble</label>
                        </div>
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="clei" id="clei" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                    <div class="body_container_nivelcuatro">
                        <div class="body_label">
                            <label>Documento de Descripción del inmueble</label>
                        </div>
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="ddi" id="ddi" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                    <div class="body_container_nivelcuatro">
                        <div class="body_label">
...
<script type="text/javascript" language="javascript" src="../Libraries/contract/contractmandate.js" charset="utf-8"></script>