            ...
            <div class="body_form">
                ...
                <div class="title_form_uno">
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_select">
                            <select class="selectitem" name="formatovin" id="formatovin">
                ...
                <div class="title_form_dos">
                    ...
                    <div class="body_container_nivelcuatro">
                        <div class="body_label">
                            <label>Solicitud de vinculación para Arrendamiento</label>
                        </div>
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="sva" id="sva" accept=".doc, .docx, .pdf">
                        </div>
                    </div>

                    <div class="body_container_nivelcuatro">
                        <div class="body_label">
                            <label>Autorización del Uso de Datos Personales</label>
                        </div>
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="auda" id="auda" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                ...
                <div class="title_form_dos">
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="svcuno" id="svcuno" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="audcuno" id="audcuno" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                ...
                <div class="title_form_dos">
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="svcdos" id="svcdos" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="audcdos" id="audcdos" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                ...
                <div class="title_form_uno">
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_select">
                            <select class="selectitem" name="contracta" id="contracta">
                               <option value="" selected>Seleccione Subserie Documental</option>
                            </select>
                        </div>   
                    </div>
                ...
                <div class="title_form_dos">
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="ca" id="ca" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                ...
                <div class="title_form_uno">
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_select">
                            <select class="selectitem" name="arrendatarioa" id="arrendatarioa">
                               <option value="" selected>Seleccione Subserie Documental</option>
                            </select>
                        </div>   
                    </div>
                    ...
                    <div class="body_container_nivelcuatro">
                        <div class="body_label">
                            <label>Fotocopia de la Cedula de Ciudadania 150%</label>
                        </div>
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="fcca" id="fcca" accept=".doc, .docx, .pdf">
                        </div>
                    </div>

                    <div class="body_container_nivelcuatro">
                        <div class="body_label">
                            <label>Copia del Rut</label>
                        </div>
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="cra" id="cra" accept=".doc, .docx, .pdf">
                        </div>
                    </div>

                    <div class="body_container_nivelcuatro">
                        <div class="body_label">
                            <label>Soportes de Actividad Comercial y Laboral (varios)</label>
                        </div>
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="sopactlaba[]" id="sopactlaba" accept=".doc, .docx, .pdf" multiple>
                        </div>
                    </div>
                
                <!-- Registro de Codeudor 1 -->
                <div class="title_form_uno">
                ...
                <!--Fin Registro de Codeudor 1 -->
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="fcccuno" id="fcccuno" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="crcuno" id="crcuno" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="sopactlabcuno[]" id="sopactlabcuno" accept=".doc, .docx, .pdf" multiple>
                        </div>
                    </div>

                <!-- Registro de Codeudor 2 -->
                <div class="title_form_uno">
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="fcccdos" id="fcccdos" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="crcdos" id="crcdos" accept=".doc, .docx, .pdf">
                        </div>
                    </div>
                    ...
                    <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_input">
                            <input class="textnameniveluno" type="file" name="sopactlabcdos[]" id="sopactlabcdos" accept=".doc, .docx, .pdf" multiple>
                        </div>
                    </div>
                ...
                <div class="body_container_nivelcuatro">
                        ...
                        <div class="body_select">
                            <select class="selectitem" name="reqprop" id="reqprop">
                               <option value="" selected>Seleccione Subserie Documental</option>
                            </select>
                        </div>   
                    </div>
                ...
                <div class="title_form_uno">
                    <button type="button" id="create" name="create" class="button_session" value="create"><span>REGISTRAR</span></button>
                </div>
            </div>
        </form>
    </div>
</div>
<script type="text/javascript" language="javascript" src="../Libraries/contract/contractleasing.js" charset="utf-8"></script>